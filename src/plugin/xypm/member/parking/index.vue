...
import parkingApi from "@/views/xypm/api/build/parking.js";
...
const options = reactive({
  ...
  import:{
    ...
    url: '/app/xypm/admin/member/import?type=parking',
    templateUrl: `${window.location.protocol}/xypm/file/车位户主导入模板.xlsx`,
    func: async () => {
      editRef.value?.open()
    },
  },
