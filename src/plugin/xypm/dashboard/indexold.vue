      ...
      <a-row :gutter="16" class="sales-row">
        ...
        <a-col :xs="24" :sm="12" :md="8">
          <div class="sales-box">
            <h4>
              交费订单
              <router-link to="/xypm/bill/order/index?ref=addtabs">
        ...
        <a-col :xs="24" :sm="12" :md="8">
          <div class="sales-box">
            <h4>
              充值订单
              <router-link to="/xypm/recharge/order/index?ref=addtabs">
                查看订单 <a-icon type="right" />
              </router-link>
            </h4>
            <div class="top text-center">
        ...
        <a-col :xs="24" :sm="12" :md="8">
          <div class="sales-box">
            <h4>
              商品订单
              <router-link to="/xypm/goods/order/index?ref=addtabs">
                查看订单 <a-icon type="right" />
              </router-link>
            </h4>
            <div class="top text-center">
...
export default {
  ...
  data() {
    return {
      ...
      // 订单数据
      orderTotalMoney: 45689.00,
      orderTotalNum: 256,
      orderTodayMoney: 1256.00,
      orderTodayNum: 8,
      orderMonthMoney: 12568.00,
      orderMonthNum: 68,

      rechargeTotalMoney: 32568.00,
      rechargeTotalNum: 189,
      rechargeTodayMoney: 856.00,
      rechargeTodayNum: 5,
      rechargeMonthMoney: 8956.00,
      rechargeMonthNum: 42,

      goodsTotalMoney: 15689.00,
      goodsTotalNum: 145,
      goodsTodayMoney: 456.00,
      goodsTodayNum: 3,
      goodsMonthMoney: 3568.00,
      goodsMonthNum: 28,
        ...
        series: [
          {
            name: '交费订单',
            type: 'bar',
            data: [1256, 1568, 856, 2256, 1895, 1056, 568],
            markPoint: {
              data: [
                { type: 'max', name: '最大值' },
                { type: 'min', name: '最小值' }
          ...
          },
          {
            name: '充值订单',
            type: 'bar',
            data: [856, 1256, 568, 1568, 1056, 568, 256],
            markPoint: {
              data: [
                { type: 'max', name: '最大值' },
                { type: 'min', name: '最小值' }
          ...
          },
          {
            name: '商品订单',
            type: 'bar',
            data: [456, 568, 256, 856, 568, 356, 156],
            markPoint: {
              data: [
                { type: 'max', name: '最大值' },
                { type: 'min', name: '最小值' }
