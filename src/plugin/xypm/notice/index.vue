...
const options = reactive({
  api: api.getNoticeList, // Adjust API method as needed
  rowSelection: { showCheckedAll: true },
  add: {
    show: true,
    auth: ['/app/xypm/notice/save'],
    func: async () => {
      editRef.value?.open()
    },
  },
...
const columns = reactive([
  ...
  { title: '缩略图', dataIndex: 'image', width: 150 },
