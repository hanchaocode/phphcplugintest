  ...
  <div class="ma-content-block">
    <sa-table ref="crudRef" :options="options" :columns="columns" :searchForm="searchForm">
      ...
      <template #tableSearch>
        ...
        <a-col :span="5">
          <a-form-item label="车位" field="build_id" >
            <a-select
      ...
      <template #tableBeforeButtons>
        ...
        <a-button type="primary"  @click="openBuildModal('parking')">
...
import parkingApi from '../../api/build/parking.js'
...
const columns = reactive([
  { title: '车位', dataIndex: 'buildname', width: 120 },
...
const initPage = async () => {
  const houseResp = await parkingApi.getParkingOption()
